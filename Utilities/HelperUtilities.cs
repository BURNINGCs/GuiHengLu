...
public static class HelperUtilities
{
    ...
    // 正值调试检查 —— 如果允许为零，将 isZeroAllowed 设为 true。若存在错误则返回 true
    ...
    //正值范围调试检查 —— 如果最小值和最大值范围都可以为零，将 isZeroAllowed 设为 true。若存在错误则返回 true
...
float valueToCheckMaximum, bool isZeroAllowed)
    ...
    //重载版本（整数）正值范围调试检查 —— 如果最小值和最大值范围都可以为零，将 isZeroAllowed 设为 true。若存在错误则返回 true
