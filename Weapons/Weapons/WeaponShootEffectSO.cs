...
public class WeaponShootEffectSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("射击特效的颜色渐变。该渐变用于定义粒子在其生命周期内的颜色变化 —— 从左至右对应粒子从生成到消失的色彩过渡")]
    #endregion Tooltip
    ...
    #region Tooltip
    [Tooltip("武器射击特效预制体（weaponShootEffectPrefab）包含射击特效的粒子系统，其参数由武器射击特效可脚本化对象（weaponShootEffect SO）配置")]
    #endregion Tooltip
